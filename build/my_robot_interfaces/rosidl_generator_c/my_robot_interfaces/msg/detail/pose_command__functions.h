...
// IWYU pragma: private, include "my_robot_interfaces/msg/pose_command.h"


#ifndef MY_ROBOT_INTERFACES__MSG__DETAIL__POSE_COMMAND__FUNCTIONS_H_
#define MY_ROBOT_INTERFACES__MSG__DETAIL__POSE_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * my_robot_interfaces__msg__PoseCommand__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_robot_interfaces
my_robot_interfaces__msg__PoseCommand *
my_robot_interfaces__msg__PoseCommand__create(void);

/// Destroy msg/PoseCommand message.
/**
 * It calls
 * my_robot_interfaces__msg__PoseCommand__fini()
 ...
 * my_robot_interfaces__msg__PoseCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * my_robot_interfaces__msg__PoseCommand__Sequence__fini()
 * on the array,
...
#endif  // MY_ROBOT_INTERFACES__MSG__DETAIL__POSE_COMMAND__FUNCTIONS_H_
