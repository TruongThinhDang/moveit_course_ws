...
#include "my_robot_interfaces/msg/detail/pose_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::msg::PoseCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::msg::PoseCommand & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::msg::PoseCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
max_serialized_size_key_PoseCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::msg::PoseCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::msg::PoseCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PoseCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_robot_interfaces::msg::PoseCommand *>(
...
static size_t _PoseCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PoseCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PoseCommand__callbacks = {
...
static rosidl_message_type_support_t _PoseCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PoseCommand__callbacks,
...
{
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_PoseCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, msg, PoseCommand)() {
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_PoseCommand__handle;
}
